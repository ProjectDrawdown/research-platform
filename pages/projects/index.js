        ...
        <HStack paddingBottom="20px">
          <FormControl as="fieldset">
            ...
            <Input
              ...
              onChange={(e) => handleFormChange("tag", e)}
            />
          </FormControl>
        </HStack>
            ...
            <PopoverContent>
              ...
              <PopoverBody>
                <AddForm
                  ...
                  popState={popState}
                  setProjectsDefault={setProjectsDefault}
                />
              </PopoverBody>
              <PopoverFooter />
            </PopoverContent>
...
const browseProjects = () => {
  ...
  const [projects, setProjects] = useState([
    {
      name: "UN data on solar water heater",
      status: "active",
      color: "#006ED3",
      tag: "model",
    },
    {
      name: "GIS data to land use modal implenmentation",
      status: "active",
      color: "#006ED3",
      tag: "data",
    },
    {
      name: "Greenpeace reference senarios to the 2020 reference cases",
      color: "#09AF74",
      tag: "pdf",
    },
    {
      name: "Diffrent First Cost Model for Solal Energy in China",
      color: "#09AF74",
      tag: "",
    },
  ]);
